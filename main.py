...
database_url = os.environ.get("DATABASE_URL", 'sqlite:///blog.db').replace("postgres://", "postgresql://")
...
# create admin_only decorator function
...
def register():
    ...
    if register_form.validate_on_submit():
        ...
        # check if user is already in users.db
        ...
        # hashing password
        hashing_password = generate_password_hash(password=password,
